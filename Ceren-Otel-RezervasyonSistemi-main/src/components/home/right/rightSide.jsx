        ...
        <main className='RightSide'>
            <section className='rigtSide__head'>
                <article className='rigtSide__heading'>
                    <h4 className='rigtSide__header'>Ceren Downtown Hotel (9.0)<span><AiFillStar className='rigtSide__icon' /><AiFillStar className='rigtSide__icon' /><AiFillStar className='rigtSide__icon' /></span></h4>
                    <p className='rightSide__map'><span><FaMapMarker /></span> Urla, Merkez</p>
                </article>
